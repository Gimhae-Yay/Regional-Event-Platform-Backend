...
| [ADR-0114](../adr/0114-support-cross-origin-browser-authentication-with-configured-allowlist.md#결정) | 단일 교차 출처 CORS Origin, Refresh Cookie와 Origin 검증 경계 |

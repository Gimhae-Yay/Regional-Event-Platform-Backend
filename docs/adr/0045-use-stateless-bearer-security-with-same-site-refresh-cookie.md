# ADR-0045: 동일 사이트 Refresh 쿠키 조건에서 무상태 Bearer 보안 체인을 사용한다
...
- Access Token의 개별 즉시 폐기는 제공하지 않으며 ADR-0043의 15분 자연 만료를 수용한다.
...
ADR-0043의 유효기간 동안 존재할 수 있으므로, 키 유출이나 잘못된 인증 허용이 확인되면 롤백만 하지 않고

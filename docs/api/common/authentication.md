...
| 인증 제외 API | `POST /api/v1/auth/signup`, `POST /api/v1/auth/login`, `POST /api/v1/auth/refresh`, `POST /api/v1/auth/logout`, `GET /api/v1/regions`, `GET /api/v1/regions/{regionId}/home`, `GET /api/v1/contents/{contentId}/sessions`, `GET /api/v1/sessions/{sessionId}`, `GET /api/v1/contents/{contentId}/reviews` |

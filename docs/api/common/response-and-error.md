...
| 409 | `REVIEW_CREATE_CONFLICT` | 후기를 작성할 수 없는 상태입니다. | 방문당 후기 유일성 또는 동시 작성으로 새 후기를 작성할 수 없는 상태 |
| 409 | `REVIEW_UPDATE_CONFLICT` | 후기를 수정할 수 없는 상태입니다. | 후기 상태, 수정 가능 기간 또는 동시 상태 전이로 후기를 수정할 수 없는 상태 |

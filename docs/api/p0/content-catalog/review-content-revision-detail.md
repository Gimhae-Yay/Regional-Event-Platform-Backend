...
| 소유 도메인 | 지역·콘텐츠 카탈로그 |
| 기준 문서 | [지역·콘텐츠 카탈로그](../../../p0/content-catalog.md), [인증·프로필](../../../p0/auth-profile.md), [ERD](../../../erd.md), [ADR-0032](../../../adr/0032-block-automatic-publication-during-pre-publication-revision-review.md), [API 공통 계약](../../common/README.md) |
...
| --- | --- | --- | --- |
| `Authorization` | Header | Y | `Bearer <accessToken>` 형식의 활성 `REGION_ADMIN` Access Token |

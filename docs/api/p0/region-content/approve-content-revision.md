...
6. 승인·반려·철회·자동 공개·콘텐츠 중단·전체 철회·종료가 경합하면 현재 수정본·원본 상태와 버전을 조건으로 먼저 커밋한 하나만 성공한다. 콘텐츠 중단·전체 철회·종료가 먼저 `EDIT_INVALIDATED`를 커밋하면 이 요청은 `409 CONTENT_STATE_CONFLICT`로 거부한다. 전체 철회가 먼저 성공한 무효화 사유는 `CONTENT_WITHDRAWN`이다.

...
| --- | --- | --- | --- |
| 인증·프로필 | 작성 전 — `p0/auth-profile/`에 생성 | [인증·프로필](../p0/auth-profile.md) | 회원가입·로그인, 역할·지역 권한, 운영자 승인, 개인정보 |
| 지역·콘텐츠 카탈로그 | [내 콘텐츠 회차 수정](p0/content-catalog/session-update.md), [내 콘텐츠 회차 생성](p0/content-catalog/session-create.md), [소유 운영자 회차 취소](p0/content-catalog/session-cancel.md) | [지역·콘텐츠 카탈로그](../p0/content-catalog.md) | 지역 선택, 콘텐츠·회차, 공개·승인·운영 상태 |

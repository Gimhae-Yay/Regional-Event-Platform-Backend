...
| --- | --- | --- | --- |
| 인증·프로필 | [회원가입](p0/auth-profile/signup.md), [로그인](p0/auth-profile/login.md), [Access Token 재발급](p0/auth-profile/refresh.md) — 권한·운영자 승인 API는 작성 전 | [인증·프로필](../p0/auth-profile.md) | 회원가입·로그인, 역할·지역 권한, 운영자 승인, 개인정보 |

...
public class PlatformAdminRegionController {
    ...
    private static final Logger log = LoggerFactory.getLogger(PlatformAdminRegionController.class);
    ...
    public ResponseEntity<ApiResponse<GetPlatformAdminRegionsResponse>> getRegions(
        ...
        Boolean parsedIsPublic;
        try {
            parsedIsPublic = toIsPublic(isPublic);
        } catch (BusinessException exception) {
            logListResult(requestId, FAILURE_RESULT_COUNT, exception.getErrorCode().code());
            throw exception;
        }

...
@Service
public class RequestStampbookPublicationUseCase {
    ...
    public RequestStampbookPublicationUseCase(
    ...
    @Transactional
    public RequestStampbookPublicationResult request(
        Long userId,
        RequestStampbookPublicationCommand command,
        UUID requestId
    ) {
        ...
        validateRewardCouponPolicy(stampbook);
        ...
        return RequestStampbookPublicationResult.from(stampbook, requestedAt);
    }

    private void validateCommand(RequestStampbookPublicationCommand command) {
        if (command == null
    ...
    private void validateRewardCouponPolicy(Stampbook stampbook) {
        couponPolicyService.findStampbookRewardPolicy(
            stampbook.getRewardCouponPolicy().getCouponPolicyId(),
            stampbook.getRegion().getRegionId()
        );
    }

    public record RequestStampbookPublicationCommand(
        Long stampbookId,
        String reason
    ) {

        public RequestStampbookPublicationCommand {

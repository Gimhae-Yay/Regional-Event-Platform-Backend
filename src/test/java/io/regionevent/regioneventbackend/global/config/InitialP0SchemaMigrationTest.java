...
class InitialP0SchemaMigrationTest {
    ...
    void 빈_데이터베이스에_현재_스키마를_생성한다() {
        ...
        List<String> contentLogIndexNames = jdbcTemplate.queryForList(
            """
                SELECT index_name
                FROM information_schema.indexes
                WHERE table_schema = 'PUBLIC'
        ...
        assertThat(constraintNames).contains(
            ...
            "UK_COUPON_POLICY_UPDATE_HISTORY_AUDIT_EVENT",
            "FK_COUPON_POLICY_UPDATE_HISTORY_POLICY",
            "FK_COUPON_POLICY_UPDATE_HISTORY_AUDIT",
            "CK_COUPON_POLICY_UPDATE_HISTORY_ACTOR_KIND",
            "CK_COUPON_POLICY_UPDATE_HISTORY_ACTOR_ROLE",
            "CK_COUPON_POLICY_UPDATE_HISTORY_REASON",
            "CK_COUPON_POLICY_UPDATE_HISTORY_PREVIOUS_DISCOUNT",
            "CK_COUPON_POLICY_UPDATE_HISTORY_NEXT_DISCOUNT",
            "CK_COUPON_POLICY_UPDATE_HISTORY_PREVIOUS_MINIMUM_PAYMENT",
            "CK_COUPON_POLICY_UPDATE_HISTORY_NEXT_MINIMUM_PAYMENT",
            "CK_COUPON_POLICY_UPDATE_HISTORY_PREVIOUS_VALID_DAYS",
            "CK_COUPON_POLICY_UPDATE_HISTORY_NEXT_VALID_DAYS",
            "CK_COUPON_POLICY_UPDATE_HISTORY_PREVIOUS_ISSUE_PERIOD",
            "CK_COUPON_POLICY_UPDATE_HISTORY_NEXT_ISSUE_PERIOD",
            "CK_COUPON_POLICY_UPDATE_HISTORY_PREVIOUS_TOTAL_ISSUE_LIMIT",
            "CK_COUPON_POLICY_UPDATE_HISTORY_NEXT_TOTAL_ISSUE_LIMIT",
        ...
        assertThat(contentLogIndexNames).contains("IDX_CONTENT_LOG_CONTENT_STATUS_DATE_ID");

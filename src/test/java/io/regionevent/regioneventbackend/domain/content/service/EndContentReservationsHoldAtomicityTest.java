...
class EndContentReservationsHoldAtomicityTest {
    ...
    @Autowired
    EndContentReservationsHoldAtomicityTest(
    ...
    @Test
    void 홀드무효화에_실패하면_콘텐츠로그와_정원을_함께_롤백한다() {
        Fixture fixture = createFixture();
        doThrow(new IllegalStateException("capacity hold processing failure"))
            .when(capacityHoldService)
            .invalidateAllActiveHoldsForContent(anyLong(), anyString());
